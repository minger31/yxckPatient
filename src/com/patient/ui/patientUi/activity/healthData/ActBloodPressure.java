 ...
 *
 */
public class ActBloodPressure extends BaseActivity implements OnClickListener {
	
	private static final String TAG = ActBloodPressure.class.getName(); 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG, "ActBloodPressure===============onCreate");
		TitleBar bar = getTitleBar();
		bar.setBack("", null, R.drawable.ic_back);
		bar.setTitle("血压", R.color.white);
		init();		
	}
	...
	public void onClick(View v) {
		...
		case R.id.rl_add_date://添加数据点
			Intent intent = new Intent(ActBloodPressure.this, ActAddDate.class);
			intent.putExtra(CommonConstant.KEY_RESLUT, CommonConstant.BLOOD_PRESSURE); 
	...
	private void getFitnessValue() {
		...
		params.addQueryStringParameter("fitnessIndexId", "fi_10009");
