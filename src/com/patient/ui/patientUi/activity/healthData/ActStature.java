 ...
 *
 */
public class ActStature extends BaseActivity implements OnClickListener {
	
	private static final String TAG = ActStature.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG, "ActStature===============onCreate");
		TitleBar bar = getTitleBar();
		bar.setBack("", null, R.drawable.ic_back);
		bar.setTitle("身高", R.color.white);
		init();		
	}
	...
	public void onClick(View v) {
		...
		case R.id.rl_add_date://添加数据点
			Intent intent = new Intent(ActStature.this, ActAddDate.class);
			intent.putExtra(CommonConstant.KEY_RESLUT, CommonConstant.STATURE); 
	...
	private void getFitnessValue() {
		...
		params.addQueryStringParameter("fitnessIndexId", "fi_10002");
