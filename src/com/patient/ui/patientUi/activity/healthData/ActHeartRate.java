 ...
 *
 */
public class ActHeartRate extends BaseActivity implements OnClickListener {
	
	private static final String TAG = ActHeartRate.class.getName(); 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG, "ActHeartRate===============onCreate");
		TitleBar bar = getTitleBar();
		bar.setBack("", null, R.drawable.ic_back);
		bar.setTitle("心率", R.color.white);
		init();		
	}
	...
	public void onClick(View v) {
		...
		case R.id.rl_add_date://添加数据点
			Intent intent = new Intent(ActHeartRate.this, ActAddDate.class);
			intent.putExtra(CommonConstant.KEY_RESLUT, CommonConstant.HEART_RATE); 
	...
	private void getFitnessValue() {
		...
		params.addQueryStringParameter("fitnessIndexId", "fi_10007");
