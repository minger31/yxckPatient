 ...
 *
 */
public class ActOxygenContent extends BaseActivity implements OnClickListener {
	
	private static final String TAG = ActOxygenContent.class.getName(); 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG, "ActOxygenContent===============onCreate");
		TitleBar bar = getTitleBar();
		bar.setBack("", null, R.drawable.ic_back);
		bar.setTitle("含氧量", R.color.white);
		init();		
	}
	...
	public void onClick(View v) {
		...
		case R.id.rl_add_date://添加数据点
			Intent intent = new Intent(ActOxygenContent.this, ActAddDate.class);
			intent.putExtra(CommonConstant.KEY_RESLUT, CommonConstant.OXYGEN_CONTENT); 
	...
	private void getFitnessValue() {
		...
		params.addQueryStringParameter("fitnessIndexId", "fi_10008");
