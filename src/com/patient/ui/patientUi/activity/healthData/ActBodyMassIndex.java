 ...
 *
 */
public class ActBodyMassIndex extends BaseActivity implements OnClickListener {
	
	private static final String TAG = ActBodyMassIndex.class.getName(); 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bar.setTitle("体重指数", R.color.white);
		init();		
	}
	...
	public void onClick(View v) {
		...
		case R.id.rl_add_date://添加数据点
			Intent intent = new Intent(ActBodyMassIndex.this, ActAddDate.class);
			intent.putExtra(CommonConstant.KEY_RESLUT, CommonConstant.BODY_MASS_INDEX); 
	...
	private void getFitnessValue() {
		...
		params.addQueryStringParameter("fitnessIndexId", "fi_10004");
