 ...
 *
 */
public class ActWeight extends BaseActivity implements OnClickListener {
	
	private static final String TAG = ActWeight.class.getName();
	...
	public void onClick(View v) {
		...
		case R.id.rl_add_date://添加数据点
			Intent intent = new Intent(ActWeight.this, ActAddDate.class);
			intent.putExtra(CommonConstant.KEY_RESLUT, CommonConstant.WEIGHT); 
	...
	private void getFitnessValue() {
		...
		params.addQueryStringParameter("fitnessIndexId", "fi_10003");
