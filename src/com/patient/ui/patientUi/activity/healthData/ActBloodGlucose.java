 ...
 *
 */
public class ActBloodGlucose extends BaseActivity implements OnClickListener {
	
	private static final String TAG = ActBloodGlucose.class.getName(); 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG, "ActBloodGlucose===============onCreate");
		TitleBar bar = getTitleBar();
		bar.setBack("", null, R.drawable.ic_back);
		bar.setTitle("血糖", R.color.white);
		init();		
	}
	...
	public void onClick(View v) {
		...
		case R.id.rl_add_date://添加数据点
			Intent intent = new Intent(ActBloodGlucose.this, ActAddDate.class);
			intent.putExtra(CommonConstant.KEY_RESLUT, CommonConstant.BLOOD_GLUCOSE); 
	...
	private void getFitnessValue() {
		...
		params.addQueryStringParameter("fitnessIndexId", "fi_10010");
