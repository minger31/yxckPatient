 ...
 *
 */
public class ActAnimalHeat extends BaseActivity implements OnClickListener {
	
	private static final String TAG = ActAnimalHeat.class.getName(); 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG, "ActAnimalHeat===============onCreate");
		TitleBar bar = getTitleBar();
		bar.setBack("", null, R.drawable.ic_back);
		bar.setTitle("体温", R.color.white);
		init();		
	}
	...
	public void onClick(View v) {
		...
		case R.id.rl_add_date://添加数据点
			Intent intent = new Intent(ActAnimalHeat.this, ActAddDate.class);
			intent.putExtra(CommonConstant.KEY_RESLUT, CommonConstant.ANIMAL_HEAT);//体温
	...
	private void getFitnessValue() {
		...
		params.addQueryStringParameter("fitnessIndexId", "fi_10005");
