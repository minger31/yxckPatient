...
// 播放资讯的视频文件
public class ActPlayVideo extends Activity  {

	private VideoView mVideoView;
	private TextView tvcache;
	private String remoteUrl;
	private String localUrl;
	private CommonWaitDialog progressDialog = null;

	private static final int READY_BUFF = 500 * 1024;
		...
		mHandler.post(new Runnable() {
			...
			public void run() {
				if (progressDialog == null) {
					progressDialog =  new CommonWaitDialog(ActPlayVideo.this, "正在努力加载视频");
				}
			}
		});
	}
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					if (mediaLength == -1) {
						dismissProgressDialog();
						LogUtil.d("mediaLength=="+mediaLength);
