...
public class BasicImageDetailAdapter extends BaseAdapter {
	
	private static final String TAG = BasicImageDetailAdapter.class.getName();
	...
	public BasicImageDetailAdapter(Context context,GridView gv) {
