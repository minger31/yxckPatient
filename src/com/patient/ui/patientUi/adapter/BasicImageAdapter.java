...
public class BasicImageAdapter extends BaseAdapter {
	...
	public BasicImageAdapter(Context context,GridView gv , boolean isCommitVisit) {
		this.isCommitVisit = isCommitVisit;
		this.context = context;
		this.gv = gv;
		layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		wordSize = context.getResources().getDimensionPixelSize(R.dimen.word_size_14sp);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		// 显示图片
		RelativeLayout.LayoutParams imgLp = (RelativeLayout.LayoutParams) viewHolder.imageTarget.getLayoutParams();
		imgLp.width = imgSize;
...
//				}
	...
	private RefreshBasicInfo listener;
	public interface RefreshBasicInfo{
		 
		public void doDel(String url);
	}
	
	public void setRefreshBasicInfo(RefreshBasicInfo listener){
