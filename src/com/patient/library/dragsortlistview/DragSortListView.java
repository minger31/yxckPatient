...
public class DragSortListView extends ListView {
    ...
    /**
     * Flag to make sure float View isn't measured(测量) twice
     */
    ...
    /**
     * Transparency(透明�? for the floating View (XML attribute).
     */
...
//        private int mFirstFooter;
    ...
    /**
	 * 删除item，并播放动画,该方法仅用于删除多个View时调�?	 * @param rowView 播放动画的view
...
//		final MyAnimation translate = new MyAnimation(0, maxWidth, 0, 0);
		final TranslateAnimation translate = new TranslateAnimation(0, maxWidth, 0, 0);
