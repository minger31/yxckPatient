...
public class ImageCache {
    ...
    private static final int DEFAULT_COMPRESS_QUALITY = getDefaultCompressQuality();
    ...
    private static int getDefaultCompressQuality() {
...
//                            Toast.makeText(DoctorApplication.getContext(),
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    Log.e(TAG, "getBitmapFromDiskCache - IOException" + e);
                } catch(OutOfMemoryError e){
                	Log.e(TAG, "getBitmapFromDiskCache - OutOfMemoryError" + e);
                }finally {
                    try {
                        if (inputStream != null) {
                            inputStream.close();
...
//    	/storage/emulated/0/Android/data/com.yxck.doctor/cache/yxckDoctor/imageCache
